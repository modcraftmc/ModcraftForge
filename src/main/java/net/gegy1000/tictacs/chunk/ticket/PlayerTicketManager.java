...
public final class PlayerTicketManager implements TicketTracker {
    ...
    public PlayerTicketManager(ChunkController controller, ChunkStep step, int radius, TicketType<ChunkPos> ticketType, int levelStep) {
        ...
        while (true) {
            ...
            if (!queue.isEmpty()) {
                ...
                while (iterator.hasNext()) {
                    ...
                    ticketManager.registerWithLevel(this.ticketType, pos, this.ticketLevel, pos);
                }
    ...
    private void removeChunkTicket(long posKey) {
        ...
        this.controller.getTicketManager().releaseWithLevel(this.ticketType, pos, this.ticketLevel, pos);
    }
