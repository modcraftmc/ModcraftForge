...
public class ActivationRange {
        ...
        for ( PlayerEntity player : world.getPlayers() )
        {
            ...
            for ( int i1 = i; i1 <= j; ++i1 )
            {
                for ( int j1 = k; j1 <= l; ++j1 )
                {
                    ...
                    if ( chunk != null )
                    {
                        activateChunkEntities( chunk, player.getPositionVec() ); // Airplane
                    }
                }
            }
        }
     ...
     * @param chunk
     */
    private static void activateChunkEntities(Chunk chunk, Vector3d playerVec) // Airplane - add player location
    {
        // Paper start
        ...
        for (int i = 0; i < chunk.entities.size(); i++) {
            ...
            {
                // Airplane start
                Vector3d entityVec = entity.getPositionVec();
    ...
    public static int checkEntityImmunities(Entity entity) // Paper - return # of ticks to get immunity
    {
        ...
        if ( entity instanceof LivingEntity)
        {
            ...
            if ( living.isOnLadder() || living.isJumping || living.hurtTime > 0 || living.getActivePotionEffects().size() > 0 ) // Paper
            {
                return 1; // Paper
            }
    ...
    public static boolean checkIfActive(Entity entity)
    {
        ...
        if (entity.defaultActivationState || entity.ticksExisted < 20*10 || !entity.isAlive() || entity.inPortal || entity.field_242273_aw > 0) {
            return true;
        }
