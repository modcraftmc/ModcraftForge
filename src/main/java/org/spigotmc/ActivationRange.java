...
import fr.modcraftmc.forge.config.SpigotWorldConfig;
...
public class ActivationRange
{
    ...
    public static void activateEntities(ServerWorld world)
    {
        ...
        for ( PlayerEntity player : world.getPlayers() )
        {
            ...
            //TODO: if (!player.world.purpurConfig.idleTimeoutTickNearbyEntities && player.isAfk()) continue; // Purpur
    ...
    {
        //TODO: if (entity.world.purpurConfig.squidImmuneToEAR && entity instanceof net.minecraft.server.EntitySquid) return true; // Purpur
