...
public abstract class AreaMap<E> {
    ...
    public final PooledLinkedHashSets.PooledObjectLinkedOpenHashSet<E> getObjectsInRange(final ChunkPos chunkPos) {
        return this.areaMap.get(CoordinateUtils.getChunkKey(chunkPos));
    }

    @Nullable
    public final PooledLinkedHashSets.PooledObjectLinkedOpenHashSet<E> getObjectsInRange(final int chunkX, final int chunkZ) {
        return this.areaMap.get(CoordinateUtils.getChunkKey(chunkX, chunkZ));
    }
    ...
    public final void addOrUpdate(final E object, final int chunkX, final int chunkZ, final int viewDistance) {
        ...
        final long newPos = CoordinateUtils.getChunkKey(chunkX, chunkZ);
    ...
    public final boolean remove(final E object) {
        ...
        final int currentX = CoordinateUtils.getChunkX(position);
        final int currentZ = CoordinateUtils.getChunkZ(position);
    ...
    protected void validate(final E object, final int viewDistance) {
        ...
        final int centerX = CoordinateUtils.getChunkX(currPosition);
        final int centerZ = CoordinateUtils.getChunkZ(currPosition);
    ...
    private void updateObject(final E object, final long oldPosition, final long newPosition, final int oldViewDistance, final int newViewDistance) {
        final int toX = CoordinateUtils.getChunkX(newPosition);
        final int toZ = CoordinateUtils.getChunkZ(newPosition);
        final int fromX = CoordinateUtils.getChunkX(oldPosition);
        final int fromZ = CoordinateUtils.getChunkZ(oldPosition);
